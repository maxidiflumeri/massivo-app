...
- **Fase actual:** Fase 4 — Canal WhatsApp Cloud API (**sub-A ✅, sub-B ✅, sub-C ✅, sub-D ✅, sub-E ✅, sub-F.1 ✅, sub-F.1.a ✅, sub-F.1.b ✅, sub-F.1.c ✅ (mapping vars), sub-F.2.a ✅, sub-F.2.b ✅, sub-F.2.c ✅ (markdown + dark mode preview), sub-F.3 ✅ (inbox backend), sub-F.4 ✅ (inbox frontend), sub-G ✅ (quick replies admin)**; siguen **4.F.2.d media upload Meta**, 4.H opt-out, 4.I welcome, 4.J live dashboard, 4.K botones)
- **Fases completadas:** Fase 0 ✅ + Fase 1 ✅ + Fase 2 ✅ + **Fase 3 ✅** (3.E inbound postergado, decisión del dueño)
- **Última actualización:** 2026-05-04 (cierre Sesión 25, smoke test funcional ✅)
- **Branch principal:** `main`
- **Próximo paso al volver**: smoke test extendido del inbox (asignar, resolver con nota, reabrir, quick replies en distintos navegadores/pestañas), después decidir si seguimos con **4.F.2.d (media upload Meta)** o saltamos a **4.H (opt-out automático con keywords)**. Para sembrar más datos local: el dueño usa `curl` simulando webhook Meta a `POST /api/webhooks/wapi` con un `phone_number_id` válido — ver "Cómo testear local" abajo.
