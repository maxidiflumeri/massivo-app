...
- **Fase actual:** Fase 5 — Contacts unificados + Timeline cross-canal (**5.A.1 ✅** schema + migración + backfill, **5.A.2 ✅** ContactsService org-scope + endpoints + cascada de identidad + validators DNI/CUIT). Pendiente: 5.A.3 (CSV import wizard), 5.A.4 (merge UI), 5.B (timeline aggregator), 5.C (búsqueda avanzada), 5.D (frontend), 5.E (reportes).
