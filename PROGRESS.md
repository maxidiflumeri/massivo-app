...
- **Fase actual:** Fase 5 — Contacts unificados + Timeline cross-canal (**5.A.1 ✅**, **5.A.2 ✅**, **5.A.3 ✅**, **5.A.4 ✅** Merge backend, **5.B ✅** Timeline aggregator, **5.C ✅** Búsqueda avanzada). Pendiente: 5.D (frontend Contacts + Merge UI + Timeline), 5.E (reportes).
